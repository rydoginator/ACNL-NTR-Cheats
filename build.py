...
CFLAGS		= ' -Os -c ' + ARCH
ASFLAGS		= ' -Os -c -s ' + ARCH
LIBFLAGS 	= " -lg -lsysbase -lntr -lShark2NTR_dev -lctr -lc -lgcc "# -lc -lgcc --nostdlib "
...
if (os.path.isfile(COPYTOPATH)):
	print("\n");
	printf("Copying the plugin into each folder...");
	...
	print("\n\n");
	printf("Seems like something went wrong, check the compilation logs.\n\n");
