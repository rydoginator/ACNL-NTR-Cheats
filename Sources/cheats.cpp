...
namespace CTRPluginFramework
{
    ...
    void    GetSet(int set)
    {
        ...
        case 12:
            ...
            player->WriteInventorySlot(11, 0x23A4);
            player->WriteInventorySlot(12, 0x245F);
            break;
        case 24:
            for (int i = 0; i < 11; i++)
            {
            ...
            player->WriteInventorySlot(12, 0x2453);
            break;
        case 25:
            for (int i = 0; i < 11; i++)
            {
            ...
            player->WriteInventorySlot(11, wallpaper[set]);
            player->WriteInventorySlot(12, 0x2443);
            break;
        case 26:
        ...
        case 29:
            ...
            for (int i = 0; i < 6; i++)
            {
                player->WriteInventorySlot(6 + i, 0x3059 + i);
            }
            break;
        case 30:
            ...
            player->WriteInventorySlot(7, 0x2676);
            for (int i = 0; i < 6; i++)
            {
                player->WriteInventorySlot(8 + i, 0x3072 + i);
            }
            break;
        case 31:
        ...
        case 50:
            ...
            for (int i = 0; i < 11; i++)
            {
                player->WriteInventorySlot(2 + i, 0x2DB8 + i);
            }
            break;
        case 51:
