...
namespace CTRPluginFramework
{
    ...
    void    Game::Initialize(void)
    {
        ...
        WispSpoof = reinterpret_cast<u32 *>(AutoRegion(USA_AMIIBO_WISP, TO_EUR(USA_AMIIBO_WISP), TO_JAP(USA_AMIIBO_WISP), TO_WA_USA(USA_AMIIBO_WISP), TO_WA_EUR(USA_AMIIBO_WISP), TO_WA_JAP(USA_AMIIBO_WISP))());
