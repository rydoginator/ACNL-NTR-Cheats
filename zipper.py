...
if not os.path.exists("plugin"):
    for i in range(0, 3):
        os.makedirs("plugin/plugin/" + "00040000000" + str(JAP_TID_LOW + (i * 100)))
        os.makedirs("plugin/plugin/" + "0004000000198" + chr(D_ASCII + i) + "00")
...
for i in range(0, 3):
    shutil.copy2(FILE, "plugin/plugin/" + "00040000000" + str(JAP_TID_LOW + (i * 100)) + "/" + FILE)
    shutil.copy2(FILE, "plugin/plugin/" + "0004000000198" + chr(D_ASCII + i) + "00" + "/" + FILE)
